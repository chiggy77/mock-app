        ...
        <div className={`menuItems ${isMenuOpen ? "" : "open"}`}>
          ...
          <Menu>
            ...
            <MenuList className="list">
              ...
              <h5>Skin Care</h5>
            {/* product */}
              <Link   href="#"   className="link"  onClick={()=>{Navigate(`*`)}}>Face Cleanser</Link>
              <Link className="link" onClick={()=>{Navigate(`*`)}}>Face Cream</Link>
              <Link className="link" onClick={()=>{Navigate(`*`)}}>Face Serum</Link>
              <Link className="link" onClick={()=>{Navigate(`*`)}}>Packs Skin Care</Link>
              </Flex>
